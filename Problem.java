...
public class Problem {
    ...
    public static void main(String[] args) {
        try {
            // Read JSON from file
            String testcasesgiven = new String(Files.readAllBytes(Paths.get("testcases.json")));
            JSONObject jsonData = new JSONObject(testcasesgiven);
            ...
            for (BigInteger answer : results) {
                System.out.println("Secret value of C is : " + answer);
            }
